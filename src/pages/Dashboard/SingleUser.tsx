...
const SingleUser = () => {
  ...
  return (
    <div className="single-user">
      <span
        className="single-user__back-arrow"
      ...
      <div className="single-user__page-title-container">
        ...
        <div className="single-user__page-title-container__btn">
        <button className="single-user__page-title-container__blacklist-btn">
          BLACKLIST USER
        </button>
        <button className="single-user__page-title-container__activate-btn">
          ACTIVATE USER
        </button>
        </div>
      </div>
      ...
      {isLoading && isFetching ? (
        ...
        <div className="single-user__basic-info">
          <div className="single-user__basic-info__info">
            ...
            <div className="single-user__basic-info__info__ranking">
          ...
          <div className="single-user__basic-info__details-tabs">
