...
const Users = () => {
  ...
  return (
    <>
      ...
      <div data-testid="users-info" className="users-info">
        {[
          ...
          <div key={item.title} className="users-info__single-user-info">
            {item.icon}
            <p>{item.title}</p>
            <p>{item.data}</p>
          </div>
      ...
      <div data-testid="table-container" className="table-container">
        {isLoading ? (
          ...
          <h2 className="error-text">
            Opps something went wrong, please check your network connection or
            try again later
          </h2>
        ) : (
          <table>
            <thead>
              <tr>
                {[
                  ...
                  <th className="table-main-heading" key={heading}>
              ...
              {users
                ...
                ?.map((user: UserDetail) => (
                  ...
                  >
                    ...
                    <td className="data">{user?.profile?.phoneNumber}</td>
                    <td className="data">
